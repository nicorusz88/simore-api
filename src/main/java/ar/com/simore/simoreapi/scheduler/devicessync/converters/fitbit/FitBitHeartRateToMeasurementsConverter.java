        ...
        if (activitiesHearts != null) {
            activitiesHearts.forEach(activitiesHeart -> {
                if (activitiesHeart != null) {
                    activitiesHeart.getValue().getHeartRateZones().forEach(heartRateZone -> {
